        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <h2 className="text-5xl md:text-7xl font-serif font-bold text-slate-900 mb-8 leading-[1.1] tracking-tight">
                A Century of <span className="text-gcuh-maroon italic relative">
                  Academic Excellence
                  <svg className="absolute -bottom-2 left-0 w-full h-3 text-gcuh-gold/30" viewBox="0 0 100 10" preserveAspectRatio="none">
